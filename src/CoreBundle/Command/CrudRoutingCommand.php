...
//            ->addArgument('status', InputArgument::OPTIONAL, 'El status: e.g. TRUE - FALSE', false)
            ->addArgument('bundle', InputArgument::OPTIONAL, 'El bundle: CoreBundle, BackendBundle', 'BackendBundle')
        ;
    }
    ...
    /**
     * ESTE ES EL UNICO LUGAR DONDE SE AGREGA EL NOMBRE DEL CONTROLLER
     */
