...
class AssignUserHasPointOfSaleController extends BoxOneToManyController {

    const ASSOC_GROUP_NAME = 'user_has_pointofsales';
    const ASSOC_GROUP_NAME_KEY = 'point_of_sale';
    ...
    const BOXRIGHT_CLASS_PATH = PointOfSale::class;
    const BOXRIGHT_LIMIT = 20;
    const BOXRIGHT_TITLE = 'Puntos de venta';
    const BOXRIGHT_ICON = 'globe';
    const BOXRIGHT_GROUP_NAME = 'pointofsale';
    ...
    public function assignAction(Request $request)
    {
        ...
        $boxMapper
            ->add('collection_get', 'getPointOfSale')
            ->add('collection_add', 'addPointOfSale')
            ->add('collection_remove', 'removePointOfSale')
        ;
