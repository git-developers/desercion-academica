...
use BackendBundle\Form\GroupOfUsersType;
use CoreBundle\Services\Crud\Builder\CrudMapper;

class GroupOfUsersController extends CrudController {

    const CLASS_PATH = GroupOfUsers::class;
    const GROUP_NAME = 'groupofusers';
    const FORM_TYPE = GroupOfUsersType::class;
    ...
    public function indexAction()
    {
        ...
        $crudMapper
            ...
            ->add('section_title', 'Gestionar grupo de usuarios')
            ->add('section_icon', 'users')
        ...
        $dataTable
            ...
            ->addColumn('group_name', 'obj.group_name')
