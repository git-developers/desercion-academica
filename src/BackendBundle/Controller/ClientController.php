...
use BackendBundle\Form\ClientType;

class ClientController extends CrudController {

    const CLASS_PATH = Client::class;
    const GROUP_NAME = 'client';
    const FORM_TYPE = ClientType::class;
    ...
    public function indexAction()
    {
        ...
        $crudMapper
            ->add('section_title', 'Gestionar clientes')
            ->add('section_icon', 'industry')
