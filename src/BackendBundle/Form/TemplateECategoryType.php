...
class TemplateECategoryType extends AbstractType
{
    ...
    public function getParentItem($id) {
        return $this->em->getRepository(TemplateECategory::class)->find($id);
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) use ($em) {
            ...
            $form->add('templateECategory', EntityType::class, $options);
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => TemplateECategory::class,
        ]);
